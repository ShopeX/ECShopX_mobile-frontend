...
var AtAccordion = (_temp2 = _class = function (_AtComponent) {
  ...
  _createClass(AtAccordion, [{
    ...
    value: function _createData() {
      ...
      var iconCls = (0, _index6.default)((_classNames = {
        'at-icon': true
      }, _defineProperty(_classNames, "at-icon-" + (icon && icon.value), icon && icon.value), _defineProperty(_classNames, 'at-accordion__icon', true), _classNames));
