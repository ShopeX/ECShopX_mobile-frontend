...
var ArticleIndex = (_temp2 = _class = function (_BaseComponent) {
  ...
  function ArticleIndex() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ArticleIndex.__proto__ || Object.getPrototypeOf(ArticleIndex)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["info"], _this.handleClickBar = function (type) {
      console.log(type);
