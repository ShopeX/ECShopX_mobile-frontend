...
var CouponHome = (0, _index7.withPager)(_class = (_temp2 = _class2 = function (_BaseComponent) {
  ...
  function CouponHome() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = CouponHome.__proto__ || Object.getPrototypeOf(CouponHome)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["list", "page"], _this.handleGetCard = function () {
