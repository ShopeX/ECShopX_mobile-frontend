...
var Detail = (0, _index5.withBackToTop)(_class = (_temp2 = _class2 = function (_BaseComponent) {
  ...
  _createClass(Detail, [{
    ...
    value: function _createData() {
      ...
      ;
      var _id4 = this.$router.params.id;
      var _id3 = this.$router.params.id;
      var _id2 = this.$router.params.id;
  ...
  return Detail;
}(_index.Component), _class2.properties = {}, _class2.$$events = ["handleScroll", "handleShare", "scrollBackToTop", "anonymousFunc0", "handleClickToMiniProgram"], _class2.options = {
  addGlobalClass: true
}, _temp2)) || _class;
