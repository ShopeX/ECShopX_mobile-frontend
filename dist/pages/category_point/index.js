...
var CategoryPoint = (_temp2 = _class = function (_BaseComponent) {
  ...
  _createClass(CategoryPoint, [{
    ...
    value: function handleClickItem(item) {
      ...
      var url = "/pages/item/point-list?cat_id=" + category_id;
