...
}, _class.$$events = ["funPrivatesMLYG", "handleClickBtn", "funPrivateUUJLk", "funPrivateEprik"], _class.options = {
  addGlobalClass: true
}, _class.defaultProps = {
  customHeader: false,
  customFooter: false,
