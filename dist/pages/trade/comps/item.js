...
}, _class.$$events = ["funPrivateykBug", "handleClickBtn", "funPrivateZRRSh", "funPrivatekAkRE"], _class.options = {
  addGlobalClass: true
}, _class.defaultProps = {
  customHeader: false,
  customFooter: false,
