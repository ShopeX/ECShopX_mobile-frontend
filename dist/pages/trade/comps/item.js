...
}, _class.$$events = ["funPrivateSFGeV", "handleClickBtn", "funPrivateazoga", "funPrivatehPxdu"], _class.options = {
  addGlobalClass: true
}, _class.defaultProps = {
  customHeader: false,
  customFooter: false,
