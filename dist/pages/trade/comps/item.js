...
}, _class.$$events = ["funPrivateTBTIN", "handleClickBtn", "funPrivatetnkFq", "funPrivatebefMd"], _class.options = {
  addGlobalClass: true
}, _class.defaultProps = {
  customHeader: false,
  customFooter: false,
