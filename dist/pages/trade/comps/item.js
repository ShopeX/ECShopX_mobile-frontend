...
}, _class.$$events = ["funPrivateSHZxv", "handleClickBtn", "funPrivateainhn", "funPrivateLchFk"], _class.options = {
  addGlobalClass: true
}, _class.defaultProps = {
  customHeader: false,
  customFooter: false,
