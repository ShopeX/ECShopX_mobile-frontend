...
}, _class.$$events = ["funPrivateAANjw", "handleClickBtn", "funPrivateJjAAF", "funPrivatemQVin"], _class.options = {
  addGlobalClass: true
}, _class.defaultProps = {
  customHeader: false,
  customFooter: false,
