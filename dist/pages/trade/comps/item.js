...
}, _class.$$events = ["funPrivateNIUlZ", "handleClickBtn", "funPrivateIVfqJ", "funPrivateewhfR"], _class.options = {
  addGlobalClass: true
}, _class.defaultProps = {
  customHeader: false,
  customFooter: false,
