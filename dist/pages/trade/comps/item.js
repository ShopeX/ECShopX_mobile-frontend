...
}, _class.$$events = ["funPrivateVchWP", "handleClickBtn", "funPrivateHGihL", "funPrivateHIAtm"], _class.options = {
  addGlobalClass: true
}, _class.defaultProps = {
  customHeader: false,
  customFooter: false,
