...
}, _class.$$events = ["funPrivatexDecf", "handleClickBtn", "funPrivateGKfCB", "funPrivateHJquO"], _class.options = {
  addGlobalClass: true
}, _class.defaultProps = {
  customHeader: false,
  customFooter: false,
