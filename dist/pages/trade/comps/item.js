...
}, _class.$$events = ["funPrivateGDkXb", "handleClickBtn", "funPrivatecLeLI", "funPrivatelkERm"], _class.options = {
  addGlobalClass: true
}, _class.defaultProps = {
  customHeader: false,
  customFooter: false,
