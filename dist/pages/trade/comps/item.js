...
}, _class.$$events = ["funPrivateNXnNS", "handleClickBtn", "funPrivatehuKGv", "funPrivatemsBVN"], _class.options = {
  addGlobalClass: true
}, _class.defaultProps = {
  customHeader: false,
  customFooter: false,
