...
}, _class.$$events = ["funPrivatehhvRV", "handleClickBtn", "funPrivatesHfRU", "funPrivateEtpQI"], _class.options = {
  addGlobalClass: true
}, _class.defaultProps = {
  customHeader: false,
  customFooter: false,
