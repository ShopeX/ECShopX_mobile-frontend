...
}, _class.$$events = ["funPrivateIMIdi", "handleClickBtn", "funPrivateRdhir", "funPrivateVbaae"], _class.options = {
  addGlobalClass: true
}, _class.defaultProps = {
  customHeader: false,
  customFooter: false,
