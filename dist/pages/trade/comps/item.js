...
}, _class.$$events = ["funPrivateGocaJ", "handleClickBtn", "funPrivateqcdzW", "funPrivategaSsj"], _class.options = {
  addGlobalClass: true
}, _class.defaultProps = {
  customHeader: false,
  customFooter: false,
