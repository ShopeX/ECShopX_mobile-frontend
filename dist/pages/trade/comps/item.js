...
}, _class.$$events = ["funPrivatedTIkh", "handleClickBtn", "funPrivaterNVJO", "funPrivateSSEeT"], _class.options = {
  addGlobalClass: true
}, _class.defaultProps = {
  customHeader: false,
  customFooter: false,
