...
var WgtWriting = (_temp2 = _class = function (_BaseComponent) {
  ...
  function WgtWriting() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = WgtWriting.__proto__ || Object.getPrototypeOf(WgtWriting)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["info", "base", "config", "curContent", "curIdx"], _this.handleClickItem = _helper.linkPage, _this.handleSwiperChange = function (e) {
