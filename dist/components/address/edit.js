...
var AddressEdit = (_temp2 = _class = function (_BaseComponent) {
  ...
  function AddressEdit() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AddressEdit.__proto__ || Object.getPrototypeOf(AddressEdit)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["info", "multiIndex", "areaList", "value", "__fn_onDelete"], _this.bindMultiPickerChange = function () {
  ...
  _createClass(AddressEdit, [{
    ...
    value: function () {
      var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
        ...
        var info, res, nList, arrProvice, arrCity, arrCounty;
