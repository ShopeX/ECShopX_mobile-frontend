...
var IconMenu = (_temp2 = _class = function (_BaseComponent) {
  ...
  function IconMenu() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = IconMenu.__proto__ || Object.getPrototypeOf(IconMenu)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["className", "img", "icon", "iconPrefixClass", "size", "title", "to", "iconStyle"], _this.handleClick = function () {
