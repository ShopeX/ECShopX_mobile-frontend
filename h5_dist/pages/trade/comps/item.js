...
var TradeItem = (_temp2 = _class = function (_BaseComponent) {
  ...
  function TradeItem() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = TradeItem.__proto__ || Object.getPrototypeOf(TradeItem)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["info", "customHeader", "customFooter", "customRender", "renderHeader", "renderFooter"], _this.$$refs = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(TradeItem, [{
    ...
    key: "funPrivateXnbTm",
    value: function funPrivateXnbTm() {
...
}, _class.$$events = ["funPrivateXnbTm", "handleClickBtn"], _class.options = {
  addGlobalClass: true
}, _class.defaultProps = {
  customHeader: false,
  customFooter: false,
