...
export const GOODS_DETAIL_PROMOTION_TAG = ({ promotion_activity = [], discount_rate, specific_crowd = {}, activity_info = {} },isGoodDetail) => {
  ...
  const isShowSpecificCrowd = isGoodDetail ? activity_info.seckill_type != 'limited_time_sale' : !promotion_activity?.some((item) => item.tag_type == 'limited_time_sale')
