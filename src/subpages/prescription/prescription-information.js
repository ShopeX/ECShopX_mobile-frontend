...
import { P_YES, P_NO, P_SELECT, P_MALE, P_FEMALE } from './i18n-keys'
...
function PrescriptionPnformation() {
  ...
  useEffect(() => {
    Taro.setNavigationBarTitle({ title: $t('95f6bf08.a904ff') })
    const onLang = () => Taro.setNavigationBarTitle({ title: $t('95f6bf08.a904ff') })
