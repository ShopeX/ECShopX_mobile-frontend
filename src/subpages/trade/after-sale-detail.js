        ...
        <View className='scrollview-body'>
          ...
          <View className='refund-detail'>
            ...
            <View className='refund-point'>
              <SpCell title='退积分' value={info?.refund_info?.refundPoint || info?.refundPoint}></SpCell>
            </View>
            {/* {info?.freight_type=='cash' && ( */}
            <View className='refund-point'>
              <SpCell title='退运费' value={`${info?.freightType == 'point' ? `积分${info?.freightFee}` : `¥${info?.freightFee / 100}`}`}></SpCell>
            </View>
