    ...
    drawText(
      {
        ...
        fontSize: 24,
        color: '#666',
        text: ti('e7ad524b.59594a', [cartTotalNum])
      },
      drawOptions
    )
    drawText(
