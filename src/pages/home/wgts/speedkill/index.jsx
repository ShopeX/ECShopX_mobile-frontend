          ...
          goodsList.length >= base.dataCount && (
            <>
              ...
              {base.goodsLayout === 'one' && (
                <View className='wgt-speedkill__one-list'>
                  {goodsList?.map((item, index) => (
                    <SpGoodsCompactCard
              ...
              {base.goodsLayout === 'two' && (
                <View className='wgt-speedkill__two-list'>
                  <View className='wgt-speedkill__two-list-left'>
                  ...
                  <View className='wgt-speedkill__two-list-right'>
