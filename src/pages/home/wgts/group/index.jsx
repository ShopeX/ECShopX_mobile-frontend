    ...
    >
      ...
      <View className='wgt-body' style={styleNames(innerStyle)}>
        ...
        {base.goodsLayout === 'one' && (
          <View className='wgt-group__one-list'>
            {goodsList?.map((item, index) => (
              <SpGoodsCompactCard
        ...
        {base.goodsLayout === 'two' && (
          <View className='wgt-group__two-list'>
            <View className='wgt-group__two-list-left'>
            ...
            <View className='wgt-group__two-list-right'>
        ...
        {base.goodsLayout === 'three' && (
          <View className='wgt-group__three-list'>
            {goodsList?.map((item, index) => (
              <SpGoodsHeroCard
                key={item.item_id}
                info={item}
